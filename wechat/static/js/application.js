...
$.fn.spinner = function (opts) {
    return this.each(function () {
        ...
        var increaseButton = $('<button class="increase icon-add" type="button"></button>').click(function () {
            changeValue(1)
        });
        var decreaseButton = $('<button class="decrease icon-reduce" type="button"></button>').click(function () {
            changeValue(-1)
        });
...
$.fn.navfix = function (mtop, zindex) {
    var nav = $(this), mtop = mtop, zindex = zindex, dftop = nav.offset().top - $(window).scrollTop(),
        dfleft = nav.offset().left - $(window).scrollLeft(), dfcss = new Array;
