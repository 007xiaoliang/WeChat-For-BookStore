...
(function (a) {
    ...
    function q(b, c) {
        ...
        if (c.search) {
            var d = a("div." + y("search"), b), e = a("input", d), f = a("li." + y("label"), b),
                g = a("em." + y("counter"), b),
                h = a("li", b).not("." + y("subtitle")).not("." + y("label")).not("." + y("noresults")), i = "> a";
            c.showLinksOnly || (i += ", > span"), e.bind(A("keyup"), function () {
                ...
                h.add(f).addClass(y("noresult")), h.each(function () {
                    ...
                    var c = a(this), d = null, e = c.attr("id"),
    ...
    a.fn.mmenu = function (g) {
        ...
        position: "left",
        slidingSubmenus: !0,
        counters: {add: !1, count: !0},
        searchfield: {add: !1, search: !0, showLinksOnly: !0, placeholder: "Search", noResults: "No results found."},
        onClick: {close: !0, delayPageload: !0, blockUI: !1},
        configuration: {
